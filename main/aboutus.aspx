            ...
            <div class="main-bar clearfix">
                <div class="container clearfix">
                    ...
                    <div class="logo-header mostion">
						<a href="welcome.aspx"><img src="../icons/pex2.png" class="logo" alt=""></a>
					</div>
                    <!-- nav toggle button -->
                    <!-- nav toggle button -->
				...
				<div class="container">
					<div class="row align-items-center m-b50">
						...
						<div class="col-md-12 col-lg-6">
							<img src="images/our-work/about.jpg" alt=""/>
						</div>
					</div>
					<div class="row">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
                            ...
                            <asp:Button ID="btncrt" class="site-button m-t20 outline outline-2 radius-xl" 
                                runat="server" Text="Create Account" onclick="btncrt_Click" />
            ...
            <div class="container">
                <div class="row">
					<div class="col-xl-5 col-lg-4 col-md-12 col-sm-12">
                        <div class="widget">
                            <img src="../icons/pex2.png" width="180" class="m-b15" alt=""/>
